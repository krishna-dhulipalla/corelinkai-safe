...
from a2a_bridge.agent import Agent
...
class Executor(AgentExecutor):
    def __init__(self, runtime=None):
        # Pi-Bench bootstrap context_id is carried inside DataPart payloads, not
        # necessarily in the A2A task context. Use one runtime-backed agent so
        # bootstrapped sessions survive across JSON-RPC turns.
